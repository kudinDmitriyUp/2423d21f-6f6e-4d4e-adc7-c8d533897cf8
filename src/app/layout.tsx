...
export const metadata: Metadata = {
  title: "Lucas Dahl - Premium Real Estate Agent",
  description: "Expert real estate agent specializing in luxury homes and investment properties. View featured listings and schedule your consultation today.",
  keywords: "real estate agent, luxury homes, property listings, real estate investment",
  metadataBase: new URL("https://lucasdahl.com"),
  alternates: {
    canonical: "https://lucasdahl.com"
  },
  openGraph: {
    title: "Lucas Dahl - Premium Real Estate Agent",
    description: "Expert real estate services for buyers and sellers. Discover featured properties and market expertise.",
    siteName: "Lucas Dahl Real Estate",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764882916251-ayuooq6s.jpg",
        alt: "Lucas Dahl Real Estate"
      }
    ]
  },
  twitter: {
    ...
    title: "Lucas Dahl - Premium Real Estate Agent",
    description: "Expert real estate services for buyers and sellers.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764882916251-ayuooq6s.jpg"]
  },
  robots: {
    index: true,
    follow: true
